...
## 游戏内文本使用的字体。
define gui.text_font = "fonts/ChillRoundGothic_Bold.otf"

## 角色名称使用的字体。
define gui.name_text_font = "fonts/hy75_zh-cn.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "fonts/hk4e_zh-cn.ttf"
...
## 这些变量覆盖了不同类型按钮的设置。可用的按钮种类以及每种按钮的用途，请参
## 阅 gui 文档。
##
## 这些定制由默认界面使用：
