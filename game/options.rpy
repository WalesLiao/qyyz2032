...
define config.name = _("祁阳一中：2032")
...
鸣谢：suda_L   李凌涛（807）\n
（声明：部分画面由AI辅助生成）\n
{size=27}你说得对，但是祁阳一中是一座位于城东天马山麓，湘江之滨，依山傍水，风景秀丽的省重点高中。全校占地面积180余亩，面积2万多平方米，绿化覆盖面达82%。教学大楼、实验大楼、教工宿舍、学生宿舍等教学、生活设施基本符合标准，图书室藏书4万余册。体育设施基本齐全，场地约2万平方米，建有标准田径、足球场、篮球场、标准游泳池和10米跳水台。{/size}
""")
...
define config.save_directory = "QYYZ_2032-1783956716"
...
init python:
    ...
    build.classify('images/AnimeStyle/**', 'all')
...
# 网页音频
define config.webaudio_required_types = [ "audio/ogg", "audio/mp3", "audio/flac" ]
define build.android_version_name = "1.0.0"
define build.android_version_code = 10